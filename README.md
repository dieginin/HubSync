# <p align="center"><img src="https://raw.githubusercontent.com/dieginin/hubsync/main/assets/icon.png" alt="HubSync" height="200"></p>
...
It is deployed on **Fly.io** ([hubsync.fly.dev](https://hubsync.fly.dev)) for fast, secure and global delivery.
...
[https://hubsync.fly.dev](https://hubsync.fly.dev)
...
1. Open [HubSync](https://hubsync.fly.dev) in your browser.
...
### 🍏 On iOS (Safari)
1. Open [HubSync](https://hubsync.fly.dev) in Safari.
...
1. Open [HubSync](https://hubsync.fly.dev) in Chrome or Edge.
...
- **Fly.io** for deployment, caching, and SSL
